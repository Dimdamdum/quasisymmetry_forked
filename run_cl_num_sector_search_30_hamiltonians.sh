...
python cluster_number_sector_search_exact_weights.py "$molecule" "$basis" "$bondlength" variance "${OPT_ARGS[@]}" --K-sector-analysis --num-sectors-to-retain 40 --max-elec-transfer 2